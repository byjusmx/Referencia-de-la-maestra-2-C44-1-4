class Game {
  ...
  start() {
   ...
   grass = new Group();
    ...
    // Agregando el sprite del combustible al juego
    this.addSprites(bush, 4, bushImage, 0.02);

    // Agregando el sprite de moneda al juego
  ...
  handleBush(index) {
    ...
    animals[index - 1].overlap(bush, function(collector, collected) {
      player.bush = 185;
      //recolectado esta el sprie en el grupo de recolectables que activaron
      //el evento
      collected.remove();
    });
  }
